...
<head>
    ...
    <title>Contact Us - Classic Events</title>
    ...
    <main>
        <section class="contact-hero">
            <div class="contact-hero-content">
                <h1>Contact Us</h1>
                <p>Need help planning your next event? Look no further than Melodia Event Management!</p>
        ...
        <section class="contact-section">
            <div class="contact-container">
                <div class="contact-info">
                    <h2 class="contact-heading">HELP US BY<span> YOUR FEEDBACK</span></h2>
                    <p class="contact-text">We'd love to hear from you! Whether you're planning a wedding, corporate event, or any special occasion, our team is ready to help make your vision a reality.</p>
                    ...
                    <div class="contact-details">
                        <div class="contact-item">
                            ...
                            <div class="contact-item-content">
                                <h4>TALK TO OUR CLIENT SUPPORT TEAM</h4>
                                <p>+91-859-001-0011</p>
                            </div>
                        </div>
                        ...
                        <div class="contact-item">
                            ...
                            <div class="contact-item-content">
                                <h4>WRITE TO US ABOUT YOUR NEEDS</h4>
                                <p>melodiaeventmanagement@gmail.com</p>
                            </div>
                        </div>
        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        <i class="fas fa-map-marker-alt"></i>
                        <p>123 Event Street, Kerala, India</p>
                    </div>
                    <div class="contact-item">
